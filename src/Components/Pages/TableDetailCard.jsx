...
export default function TableDetailCard() {
    ...
    return (
        <div className={`container mb-2 `}>
            ...
            <div className={`container main-container ${showTableDetail && "show"}`}>
                <div className="row">
                    <div className="col-lg-6 col-md-6 p-2">
                        <div className="d-flex justify-content-lg-around justify-content-between align-items-center px-2 pt-3 pt-md-1">
                            <p className="fs-5 fw-bold w-md-25 w-auto text-start">Total Pages:</p>
                            <p className="w-50 text-md-start text-end">{totalPages}</p>
                        </div>
                    </div>
                    <div className="col-lg-6 col-md-6 px-2 py-md-2 pb-md-0 pb-3 pt-3">
