...
export default function TableComponent() {
    ...
    return (
        <>
            ...
            <div className="table-wrapper position-relative" style={{ maxHeight: "100vh", overflow: "auto" }}>
                <table onClick={() => setOpenAddModal(false)}>
                    <thead className="position-sticky top-0 z-1" style={{ backgroundColor: "#f4f4f4" }}>
                        <tr>
                            {column.map((item, index) => (
                                ...
                                >
                                    ...
                                    >
                                        <select
                                            value={item}
                                            className={`fw-bold bg-white p-2 w-${isMobile?"100":"auto"} border-0 mb-2 mb-md-0`}
