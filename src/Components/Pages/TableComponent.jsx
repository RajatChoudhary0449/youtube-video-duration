    ...
    return (
        <div className="table-responsive d-flex" >
                        ...
                        {column.map((item, index) => (
                            ...
                            >
                                ...
                                >
                                    <select
                                        value={item}
                                        className={`fw-bold p-2 w-${isMobile ? "100" : "auto"
                                            } border-0`}
            ...
            <div>
                ...
                {openAddModal &&
                    <ul className="list-unstyled ps-2">{leftColumn.map(item => (<li className="p-1 form-control" style={{ cursor: "pointer" }} onClick={() => handleAdd(item)}>{item}</li>))}</ul>
                }
            </div>
        </div>
    );
