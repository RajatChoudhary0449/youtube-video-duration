    ...
    return (
        <div className='container mb-2'>
            ...
            <div className={`container main-container ${showPlaylistDetail&&"show"}`}>
                <div className="row fs-md-5 fs-6">
                    <div className="col-lg-6 col-md-6 p-2 py-3">
                        <div className="d-flex justify-content-between align-items-center px-2">
                            <p className="fw-bold w-25 text-start mb-0">Speed:</p>
                        ...
                        <div className="d-flex justify-content-between align-items-center px-2 mt-md-5 mt-4">
                            <p className=" fw-bold w-25 w-md-auto text-start">Total Videos:</p>
                            <p className="w-50 text-md-start text-end">{time.length}</p>
                        </div>
                    </div>
                    <div className="col-lg-6 col-md-6 p-2">
                        <div className="d-flex justify-content-between align-items-center px-2">
                            <p className="fw-bold w-25 text-start">Result For Speed:</p>
                        ...
                        <div className="d-flex justify-content-between px-2 align-items-center overflow-auto">
                            <p className=" fw-bold w-25 text-start">Category:</p>
